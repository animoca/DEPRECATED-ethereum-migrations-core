...
extendConfig((config, userConfig) => {
  const tags = Array.isArray(userConfig.duplicateNetworksWithTags) ? userConfig.duplicateNetworksWithTags : [];
  if (userConfig.networks !== undefined) {
    config.networks = merge(config.networks, userConfig.networks);
  }
